...
{
    public class NbaTeamPerformanceStatsOnlyDbDto
    {
        private const string LEAGUE_NAME = "NBA";
        public NbaTeamPerformanceStatsOnlyDbDto(string seasonYear, string shortName, string fullName, string nickname, string logoUrl, int gamesPlayed, Statistics stats)
        {
